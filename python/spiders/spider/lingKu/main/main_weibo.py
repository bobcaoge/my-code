...
"Host": "www.kolstore.com",
    ...
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.92 Safari/537.36",
    "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
    "Referer": "http://www.kolstore.com/company/choose_opinionLeaders.php?olt=weibo",
    "Accept-Encoding": "gzip, deflate",
    "Accept-Language": "zh-CN,zh;q=0.9",
}
headers = {
...
def crawl(sess, page):
    json_url = "http://www.kolstore.com/interface/company/weibo.php"
    form_data={
        "page": page,
        "userType": "0",
...
def main():
    ...
    for page in range(1, 3713):
        ...
        print content
        filename = "./weibo_json/weibo_json_"+str(page)+".json"
